...
@section('content')
    ...
    <div id="conteudo" class="container">
        <div class="d-flex align-items-start">
                ...
                <button class="nav-link active" id="v-pills-contrato-tab" data-bs-toggle="pill" data-bs-target="#v-pills-contrato" type="button" role="tab" aria-controls="v-pills-contrato" aria-selected="true">
                   <div id="svg" class="d-flex justify-content-between m-2">
                    <svg width="30" height="34" viewBox="0 0 30 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M14.9395 15.0406H5.07864C4.60543 15.0406 4.22168 15.4243 4.22168 15.8976C4.22168 16.3709 4.60535 16.7546 5.07864 16.7546H14.9395C15.4127 16.7546 15.7965 16.3709 15.7965 15.8976C15.7965 15.4243 15.4127 15.0406 14.9395 15.0406V15.0406Z" fill="#FADB8C"/>
                        <path d="M11.0911 19.2967H5.07864C4.60543 19.2967 4.22168 19.6804 4.22168 20.1537C4.22168 20.6269 4.60535 21.0106 5.07864 21.0106H11.0911C11.5644 21.0106 11.9481 20.6269 11.9481 20.1537C11.9481 19.6804 11.5644 19.2967 11.0911 19.2967V19.2967Z" fill="#FADB8C"/>
                        </svg>
            ...
            <div class="tab-pane fade show active" id="v-pills-contrato" role="tabpanel" aria-labelledby="v-pills-contrato-tab">
                <ul class="list-group">
            ...
            <div class="tab-pane fade" id="v-pills-posto" role="tabpanel" aria-labelledby="v-pills-posto-tab">
                <ul class="list-group">
