...
{{-- 
<ul>
    <li>ID:                   {{ $contrato->proprietario_id }}        </li>
    <li>Nome:                 {{ $contrato->proprietario->name }}      </li>
    <li>Email:                {{ $contrato->proprietario->email }}     </li>
    <li>Celular:              {{ $contrato->proprietario->cell }}      </li>
    <li>Telefone:             {{ $contrato->proprietario->tel }}       </li>
    <li>Criação:              {{ Carbon\Carbon::parse($contrato->proprietario->create_at)->format('d/m/Y H:i') }} </li>
    <li>Última modificação:   {{ Carbon\Carbon::parse($contrato->proprietario->update_at)->format('d/m/Y H:i') }} </li>
</ul>  --}}