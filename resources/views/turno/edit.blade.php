    ...
    <div id="conteudo" class="container p-0 my-4">
        ...
        <div class="d-flex my-1">
            <div id="box1" class="form-floating w-50 me-1">
                {{ Form::select('posto_id',$postos,$turno->posto,array('class' => 'form-select', 'id'=>'posto') )}}
                {{ Form::label('posto', null, ['for'=>'posto']) }}
            </div>
            <div id="box2" class="form-floating w-50 me-1">
                {{ Form::select('name', ['manha' => 'Manhã', 'tarde' => 'Tarde', 'noite' => 'Noite','madrugada' => 'Madrugada'], $turno->name,array('class' => 'form-select', 'id'=>'name') )}}
        ...
        <div class="d-flex my-1">
            <div id="box3" class="form-floating w-50 me-1">
                {{ Form::time('horario_inicio', $turno->horario_inicio, ['class' => 'form-control', 'id'=> 'hri' , 'placeholder' => 'inicio do turno']) }}
                {{ Form::label('Inicio do Turno',null, ['for'=>'hri'] ) }}
            </div>
            <div id="box4" class="form-floating  w-50">
                {{ Form::time('horario_fim', $turno->horario_fim, ['class' => 'form-control', 'id'=> 'hrfm' , 'placeholder' => 'fim do turno']) }}
