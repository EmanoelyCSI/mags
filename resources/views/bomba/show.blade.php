 ...
 <div id="conteudo" class="container">
    ...
    <div id="box" class="d-flex mx-4 my-2 fs-5 justify-content-center">
        <ul>
            ...
            <li class="list-group">Bico:                 {{ $bomba->bico}}     </li>
            ...
            <div id="box" class="d-flex w-25 float-end">
                    <!-- boão de editar-->
                    <a class="text-decoration-none" href="{{ URL::to('bomba/' . $bomba->id . '/edit') }}">
                    ...
                    <!-- botão de excluir -->
                    {{ Form::open(array('url' => 'bomba/' . $bomba->id, 'onsubmit' => 'return ConfirmDelete()'))}}     
